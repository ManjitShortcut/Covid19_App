...
//     */
//    public  public convenience init(url: String, method: HttpMethod, request: R?) {
//        self.init()
...
//     */
//    public public convenience init(url: String, method: HttpMethod, request: R?, updateHeaders: [String: String]) {
//        self.init()
...
//     */
//    public public convenience init(url: String, method: HttpMethod, request: R?, queryParameter: [String: String]) {
//        self.init()
...
//     */
//    fileprivate func configureApiInformationWithUrl(_ url: String, withHttpsMethods method: HttpMethod, withUpdateHeaders updateHeaders : [String: String]?, withNewHeaders newHeaders: [String: String]?, withQueryParameter queryParameter: [String: String]?) {
//        _urlString = url
//        _method = method
